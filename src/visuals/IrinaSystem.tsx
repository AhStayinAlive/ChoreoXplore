...
import Lines1D from './Lines1D_Irina';
import Surfaces2D from './Surfaces2D_Ribbons';
import Volumes3D from './Volumes3D_Bursts';
...
export default function IrinaSystem(){
  ...
  if (mode === 'surfaces') return <Surfaces2D/>;
  if (mode === 'volumes')  return <Volumes3D/>;
  return <Lines1D/>;
}
