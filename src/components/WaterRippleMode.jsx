    ...
    return new THREE.ShaderMaterial({
      ...
      fragmentShader: `
        ...
        void main() {
          ...
          // Audio modulation
          float audioMod = 1.0 + (u_audio_bass * 2.0 + u_audio_mid) * u_musicReact;
          
          // Create water ripple effect
          float ripple1 = sin(dist * 20.0 * audioMod - u_time * u_speed * 2.0) * 0.02;
          float ripple2 = sin(dist * 35.0 * audioMod - u_time * u_speed * 1.5) * 0.015;
          float ripple3 = sin(dist * 50.0 * audioMod - u_time * u_speed * 1.2) * 0.01;
          
          float totalRipple = (ripple1 + ripple2 + ripple3 + u_audio_rms * 0.01) * u_intensity;
          
          // Mix colors based on ripple
          vec3 color = mix(u_bgColor, u_assetColor, abs(totalRipple) * 20.0);
